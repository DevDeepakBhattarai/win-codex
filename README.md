...
The **RALF threads** tab has separate Active and Completed views. Use **Mark complete** to stop an active thread, or **Mark active** to reschedule a completed thread for the loop.
