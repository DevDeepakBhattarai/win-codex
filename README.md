...
The **RALF threads** tab shows every active and completed registration. Use **Mark complete** on an active thread to stop RALF from checking or continuing it. The popup confirms the action, and the thread remains visible in the completed list.
